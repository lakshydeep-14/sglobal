...
class _$_UserProfileModel implements _UserProfileModel {
  ...
  @override
  String toString() {
    return 'UserProfileModel(id: $id, name: $name, username: $username, email: $email, address: $address, phone: $phone, website: $website, company: $company)';
  }
...
abstract class _UserProfileModel implements UserProfileModel {
  const factory _UserProfileModel(
      ...
      final String? phone,
      final String? website,
      final Company? company}) = _$_UserProfileModel;
